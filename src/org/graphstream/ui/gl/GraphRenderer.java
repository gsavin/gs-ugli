	...
	implements GLEventListener
{
	...
	public GraphRenderer( Context ctx )
	{
		...
		InputStream fontIn =
			ClassLoader.getSystemResourceAsStream( "org/graphstream/ui/gl/resource/verdanab.ttf" );
		
		Font font = null;
		
		try
		{
			font = Font.createFont(Font.TRUETYPE_FONT, fontIn ).deriveFont(18.0f);
		}
		catch( Exception e )
		{
			e.printStackTrace();
	...
	protected void drawFPS( GL2 gl )
	{
		...
		textRenderer.draw( String.format( "%d nodes, %d edges @ %d fps",nodeCount,edgeCount,fps ), 10, 10 );
